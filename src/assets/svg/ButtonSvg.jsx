const ButtonSvg = (white) => (
  <>
    ...
    >
      <path
        fill={white ? "#646536" : "none"}
        stroke={white ? "#646536" : "url(#btn-left)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
    ...
    >
      <path
        fill={white ? "#646536" : "none"}
        stroke={white ? "#646536" : "url(#btn-right)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
